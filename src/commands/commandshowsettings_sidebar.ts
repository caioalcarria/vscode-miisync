...
/**
 * 🎨 SIDEBAR DE CONFIGURAÇÕES MIISYNC - DESIGN ESCURO E MODERNO
 * Barra lateral dedicada com interface HTML/CSS
 */
    ...
    switch (message.command) {
      ...
      case "resetSettings":
        ...
        if (confirm === "Sim, restaurar") {
          ...
          panel.webview.html = getSettingsSidebarHTML(
      ...
      case "testConnection":
        vscode.window.showInformationMessage(
          "🔍 Testando conexão... (Funcionalidade em desenvolvimento)"
        );
        break;
    }
  }, undefined);
...
async function loadCurrentConfig(): Promise<any> {
  try {
    ...
    vscode.window.showWarningMessage(
      `⚠️ Erro ao carregar miisync.json: ${error}`
    );
    return getDefaultConfig();
  }
}
                            ...
                            <div class="section-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" id="systemName" 
                                           value="${
                                             config.systems && config.systems[0]
                                               ? config.systems[0].name
                                               : ""
                                           }" 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-input form-select" id="systemSeverity">
                                        <option value="1-low" ${
                                          config.systems &&
                                          config.systems[0] &&
                                          config.systems[0].severity === "1-low"
                                            ? "selected"
                                            : ""
                                        }>Baixa (Development)</option>
                                        <option value="2-high" ${
                                          config.systems &&
                                          config.systems[0] &&
                                          config.systems[0].severity ===
                                            "2-high"
                                            ? "selected"
                                            : ""
                                        }>Alta (QA/Test)</option>
                                        <option value="3-critical" ${
                                          config.systems &&
                                          config.systems[0] &&
                                          config.systems[0].severity ===
                                            "3-critical"
                                ...
                                <div class="toggle-container">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" id="isMainSystem" ${
                                          config.systems &&
                                          config.systems[0] &&
                                          config.systems[0].isMain
                                            ? "checked"
                                            : ""
                                        }>
                        ...
                        <div class="section-content">
                            <div class="section-body">
                                ...
                                <div class="toggle-container">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" id="downloadOnOpen" ${
                                          config.downloadOnOpen ? "checked" : ""
                                        }>
                                        <span class="slider"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" id="removeFromLocalPath" 
                                           value="${
                                             config.removeFromLocalPath
                                               ? config.removeFromLocalPath.join(
                                                   ", "
                                                 )
                                               : ""
                                           }" 
                        ...
                        <div class="section-content">
                            <div class="section-body">
                                <div class="toggle-container">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" id="useRootConfig" ${
                                          config.useRootConfig ? "checked" : ""
                                        }>
                                        <span class="slider"></span>
                                    </label>
                                </div>
